...
**DeepEarth** is a neural network architecture for high-resolution simulation of Earth's ecosystems.  It will help to more precisely predict many biological, geological, and ecological interactions across diverse geospatial and temporal contexts.  Preview our [paper](https://github.com/legel/deepearth/blob/main/docs/deepearth.pdf) to learn more.
