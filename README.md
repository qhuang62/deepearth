...
This repository supports the development of **DeepEarth**, a deep neural network for modeling Earth's ecosystems.  Introduced initially for predicting plant-pollinator interactions, in the coming months DeepEarth is expected to be adapted for plant-fire and plant-food ecohydrology.  The development of DeepEarth is led by scientists from Ecodash.ai, Stanford University, and University of Florida, with support from NSF.
