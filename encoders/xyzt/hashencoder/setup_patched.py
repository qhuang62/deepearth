#!/usr/bin/env python3
"""
Setup script for Earth4D Hash Encoder with Collision Tracking (Patched Version)
===============================================================================

This script compiles the CUDA extension for collision tracking functionality
with CUDA version check patched to allow CUDA 11.7 with PyTorch built for 12.1.

Usage:
    python setup_patched.py build_ext --inplace
"""
...
# Patch the CUDA version check
print("Patching CUDA version check to allow CUDA 11.7 with PyTorch built for 12.1...")
original_check = cpp_ext._check_cuda_version
def patched_check(*args, **kwargs):
    print('  Bypassing CUDA version check - proceeding with CUDA 11.7')
    pass
